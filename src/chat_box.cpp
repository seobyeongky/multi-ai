...
ChatBox::ChatBox()
	:  _chatting_text(G.default_font, 25),
	_my_color(),
	_my_name(),
	_msg_list(),
	_enter_done(true)
{
	...
	_chatting_text.setPosition(
		...
		static_cast<float>(300) - static_cast<float>(CHATTING_TEXT_SIZE));
...
{
	float x = static_cast<float>(25);
	float y = static_cast<float>(300) - 2 * CHATTING_TEXT_SIZE;
